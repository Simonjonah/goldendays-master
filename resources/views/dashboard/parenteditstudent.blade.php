  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Parents Edit</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ url('web/updatebyparent/'.$editby_parent->ref_no1) }}" method="post" enctype="multipart/form-data">
                  @csrf
                 ...
                 <div class="col-sm-6">
                   ...
                   <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                            {{-- <a href="{{ url('web/viewparents') }}" class="btn btn-primary">Back</a> --}}

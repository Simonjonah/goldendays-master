                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @endif
                    ...
                    @foreach ($view_subjectbyheads as $view_subjectbyhead)
                        ...
                        <tr>
                            <td>{{ $view_subjectbyhead->user['fname'] }} {{ $view_subjectbyhead->user['surname'] }}</td>
                            <td>{{ $view_subjectbyhead->classname }}</td>
                            
                            <td>{{ $view_subjectbyhead->subject['subjectname'] }}</td>
                            <td>{{ $view_subjectbyhead->subject['title'] }}</td>
                            <td>{{ $view_subjectbyhead->subject['section'] }}</td>

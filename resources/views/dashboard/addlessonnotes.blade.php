                ...
                @if (Session::get('success'))
                  ...
                  <div class="form-group">
                    ...
                    <select name="academic_session" id="" class="form-control">
                        @foreach ($view_academics as $view_academic)
                            <option value="{{ $view_academic->academic_session }}">{{ $view_academic->academic_session }}</option>
                        @endforeach
                    </select>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select name="subjectname" id="" class="form-control">
                        @foreach ($view_teachersubjects as $view_teachersubject)
                            <option value="{{ $view_teachersubject->subject['subjectname'] }}">{{ $view_teachersubject->subject['subjectname'] }}</option>
                        @endforeach
                    </select>
                  </div>

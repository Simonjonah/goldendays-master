                  ...
                  {{-- <h1>{{ $pay_fees->fname }}</h1> --}}
                    ...
                    <form method="POST" action="{{ route('pay') }}" id="paymentForm">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="hidden" class="form-control" value="{{ Auth::guard('web')->user()->email }}" name="email" type="email" placeholder="Your Email" />
                        </div>
                        <div class="form-group">
                          <input type="hidden" class="form-control" value="{{ Auth::guard('web')->user()->phone }}" name="phone" type="tel" placeholder="Phone number" />
                          <input type="hidden" class="form-control" value="{{ Auth::guard('web')->user()->id }}" name="user_id" type="number" placeholder="Phone number" />
                        ...
                        <input type="text" class="form-control" value="{{ $view_classpayment->id }}" name="payment_id" type="text" placeholder="" />

    ...
    <section class="content">
      <div class="container-fluid">
                            ...
                            <tbody>
                                ...
                                @foreach ($view_teachersubjects as $view_teachersubject)
                                  ...
                                  <tr>
                                      ...
                                      <td>{{ $view_teachersubject->subjectname }} <br> <small style="color: red">{{ $view_teachersubject->section }} 
                                        {{ $view_studentsubject->classname }} {{ $view_studentsubject->fname }} {{ $view_studentsubject->middlename }} {{ $view_studentsubject->surname }}</small><input type="hidden" value="{{ $view_teachersubject->subjectname }}" name="subjectname[]" id=""></td>
                                      ...
                                      <td><input type="hidden" name="section[]" value="{{ $view_studentsubject->section }}" placeholder="Parent ID"></td>
                                      <td><input type="hidden" name="gender[]" value="{{ $view_studentsubject->gender }}" placeholder="Parent ID"></td>
                                      <td><input type="hidden" name="academic_session[]" value="{{ $view_studentsubject->academic_session }}" placeholder="Parent ID"></td>
        ...
        <div class="row">
          ...
          <form action="{{ url('admin/createresultsadsec') }}" method="post" enctype="multipart/form-data">
            @csrf
            @if (Session::get('success'))
            <div class="alert alert-success">
                {{ Session::get('success') }}
                    ...
                    @foreach ($view_teachersubjects as $view_teachersubject)
                      ...
                      <tr>
                         <tr>
                          ...
                          <td><input type="hidden" name="regnumber[]" value="{{ $view_studentsubject->regnumber }}" placeholder="regnumber"></td>
                          <td><input type="hidden" name="section[]" value="{{ $view_studentsubject->section }}" placeholder="Parent ID"></td>
                          <td><input type="hidden" name="title[]" value="{{ $view_teachersubject->title }}" placeholder="Parent ID"></td>
                          <td><input type="hidden" name="classname[]" value="{{ $view_studentsubject->classname }}" placeholder="Parent ID"></td>
                          <td><input type="hidden" name="fname[]" value="{{ $view_studentsubject->fname }}" placeholder="Parent ID"></td>
                          <td><input type="hidden" name="middlename[]" value="{{ $view_studentsubject->middlename }}" placeholder="Parent ID"></td>
                          <td><input type="hidden" name="surname[]" value="{{ $view_studentsubject->surname }}" placeholder="Parent ID"></td>

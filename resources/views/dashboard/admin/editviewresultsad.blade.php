            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                    <div class="col-12 table-responsive">
                      <form action="{{ url('admin/updatecreateresultseditad/'.$edit_result->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td><input type="text" value="{{ $edit_result->test_1 }}" class="form-control" name="test_1" placeholder="Test 1"></td>
                                      <td><input type="text" value="{{ $edit_result->test_2 }}" class="form-control" name="test_2" placeholder="Test 2"></td>
                                      <td><input type="text" value="{{ $edit_result->test_3 }}" class="form-control" name="test_3" placeholder="Test 3"></td>

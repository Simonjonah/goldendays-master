                  ...
                  {{-- <h1>{{ $pay_fees->fname }}</h1> --}}
                    ...
                    <form method="POST" action="{{ route('pay') }}" id="paymentForm">
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control" value="{{ $view_classpayment->amount }}" name="amount" placeholder="Feeding Fee" />
                      </div>
                       
                      <div class="form-group">
                        <label for="">Route</label>
                        <input class="form-control" value="{{ $view_classpayment->address }}" name="address" placeholder="Route" />
                    </div>
                      <div class="form-group">
                        {{-- <label for="">Development Fees</label> --}}
                        <input class="form-control" value="{{ $view_classpayment->feeding }}" name="feeding" placeholder="Name" />
                    </div>
                        <div class="form-group">
                            <input class="form-control" value="{{ Auth::guard('guardian')->user()->email }}" name="email" type="email" placeholder="Your Email" />
                        </div>
                        <div class="form-group">
                          <input class="form-control" value="{{ Auth::guard('guardian')->user()->phone }}" name="phone" type="tel" placeholder="Phone number" />
                          <input class="form-control" value="{{ Auth::guard('guardian')->user()->id }}" name="guardian_id" type="number" placeholder="Phone number" />
                        ...
                        <input class="form-control" value="{{ $pay_fees->fname }}" name="fname" type="tel" placeholder="" />
                        <input class="form-control" value="{{ $pay_fees->middlename }}" name="middlename" type="text" placeholder="" />
                        <input class="form-control" value="{{ $pay_fees->surname }}" name="surname" type="text" placeholder="" />
                        <input class="form-control" value="{{ $pay_fees->id }}" name="student_id" type="text" placeholder="" />
                        <input class="form-control" value="{{ $pay_fees->section }}" name="section" type="text" placeholder="" />

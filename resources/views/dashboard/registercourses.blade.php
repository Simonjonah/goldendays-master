  ...
  <script type="text/javascript">
    $(function() {
      ...
      $('.toastrDefaultError').click(function() {
        toastr.error('Dear {{ Auth::guard('student')->user()->name }} you do not have upto N5000 to withraw')
      });
      ...
      $('.toastsDefaultFullImage').click(function() {
        $(document).Toasts('create', {
          body: 'Dear {{ Auth::guard('student')->user()->name }} your account has been suspended, please contact Whatsapp',
          title: 'Suspended',
          class: 'bg-danger', 
          subtitle: 'Subtitle',
          image: '{{ asset('/public/../'.Auth::guard('student')->user()->images)}}',

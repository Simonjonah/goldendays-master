              ...
              <div class="col-12 table-responsive">
                ...
                <table class="table table-striped">
                  ...
                  @foreach ($print_results as $print_result)
                      @if ($print_result->status = 'gen' && $print_result->programname == 'Diploma in Data Processing')
                      @php
                      ...
                      <tr>
                          ...
                          <td>{{ $print_result->programname }}</td>
                  ...
                  {{-- <td>{{ $print_result->semester }} {{ $print_result->programname }}</td> --}}
              
                  <td> <b>CGPA {{ $total_credit_hour/$total_credit_unit }}</b></td>
                        {{-- <td>{{ $total_score }}</td> --}}

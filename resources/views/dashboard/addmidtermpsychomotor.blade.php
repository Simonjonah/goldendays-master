            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="table-responsive">
                  ...
                  <form action="{{ url('web/createmidpsychomotoro/'.$add_midtermpsychomotor->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <table class="table table-bordered">
                      <tr>
                        {{-- <td><input type="text" name="" value="{{ $add_midtermpsychomotor->images }}" id=""></td> --}}

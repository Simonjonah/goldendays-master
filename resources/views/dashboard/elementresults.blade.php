                    ...
                    @foreach ($view_studentstermresults as $view_studentstermresult)
                      ...
                      <tr>
                        ...
                        <td>{{ $view_studentstermresult->user['middlename'] }}
                          @if ($view_studentstermresult->status == null)
                          <span class="badge badge-info">In review</span>
                          @elseif ($view_studentstermresult->status =='admitted')
                        ...
                        <td>{{ $view_studentstermresult->user['regnumber'] }}
                            <a href="{{ url('web/approveresultshead/'.$view_studentstermresult->id) }}"
                                class='btn btn-info'>
                                Aproved
...
<div class="modal fade" id="modal-default">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{ url('web/searchresultbyteacherelementary') }}" method="post">
        @csrf

...
{{-- 
                  ...
                  <div class="form-group">
                    <textarea class="form-control" name="headteach_comment" id="" cols="10" rows="2" placeholder="Head Teacher's Comment">{{ $view_results->headteach_comment }}</textarea>
                </div>
          ...
          <div class="col-6">
            ...
            <a class="btn btn-primary" href="{{ url('web/addcomment/'.$view_myresult_result->id) }}">Add Comment</a>

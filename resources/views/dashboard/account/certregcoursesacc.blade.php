                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach ($display_allcourses as $display_allcourse)
                        ...
                        <tr>
                          <td><a href="viewstudentaccount/{{ $display_allcourse->student['ref_no'] }}">{{ $display_allcourse->student['surname'] }}</a></td>
                          ...
                          <td><a href="{{ url('account/viewacc/'.$display_allcourse->id) }}"

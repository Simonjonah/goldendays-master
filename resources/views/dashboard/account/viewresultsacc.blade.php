            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <b>Reg Number</b> {{ $viewsingle_results->student['regnumber'] }}<br>
                  <b>Program:</b> {{ $viewsingle_results->student['course_title'] }}<br>
                  <b>Period</b> {{ $viewsingle_results->student['course_period'] }}<br>
                  <b>Gender</b> {{ $viewsingle_results->student['gender'] }}<br>
                  <b>Surname</b> {{ $viewsingle_results->student['surname'] }}<br>
                  <b>Firstname</b> {{ $viewsingle_results->student['fname'] }}<br>

                  <b>Semester</b> {{ $viewsingle_results->registercourse['semester'] }}<br>

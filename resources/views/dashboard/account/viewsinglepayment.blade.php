          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-12">
                  <h4>
                  <td>{{ $viewsingle_paymentacc->ref_no }}</td>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      <tr>
                        ...
                        <td>	{{ $viewsingle_paymentacc->fname}}</td>
                      </tr>
                      <tr>
                        <th style="width:50%">Middle Name:</th>
                        <td>	{{ $viewsingle_paymentacc->middlename}}</td>
                      </tr>

                      <tr>
                        <th style="width:50%">SurName:</th>
                        <td>	{{ $viewsingle_paymentacc->surname}}</td>
                      </tr>
                      <tr>

                        <tr>
                          <th style="width:50%">Classname:</th>
                          <td>	{{ $viewsingle_paymentacc->classname}}</td>
                        </tr>
                        <tr>

                          <tr>
                            <th style="width:50%">Term:</th>
                            <td>	{{ $viewsingle_paymentacc->term}}</td>
                          </tr>
                          <tr>
                        <th style="width:50%">Form Amount:</th>
                        <td>	₦{{ $viewsingle_paymentacc->form_amount}}</td>
                      </tr>
                      <tr>
                        <th>Tuition</th>
                        <td>	₦{{ $viewsingle_paymentacc->tuition}}</td>
                      </tr>

                      <tr>
                        <th>Address </th>
                        <td>	{{ $viewsingle_paymentacc->address}}</td>
                      </tr>
                ...
                <div class="col-6">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      <tr>
                        <th>Book Amount</th>
                        <td>₦{{ $viewsingle_paymentacc->bookamount }}</td>
                      </tr>
                      <tr>
                        <th>Form Amount</th>
                        <td>₦{{ $viewsingle_paymentacc->form_amount }}</td>
                      ...
                      <tr>
                        ...
                        <td>₦{{ $viewsingle_paymentacc->uniforms_amount }}</td>
                      </tr>
                      <tr>
                        <th>Extra Curriculum Activities</th>
                        <td>₦{{ $viewsingle_paymentacc->extracuri_fee }}</td>
                      </tr>

                      <tr>
                        <th>Medicals</th>
                        <td>₦{{ $viewsingle_paymentacc->medicals }}</td>
                      </tr>
                      <tr>
                        <th>Development Amount</th>
                        <td>	₦{{ $viewsingle_paymentacc->dev_amount}}</td>
                      </tr>
                      <tr>
                        <th>PTA</th>
                        <td>₦{{ $viewsingle_paymentacc->pta_amount }}</td>
                      </tr>
              
                      <tr>
                        <th>Amount </th>
                        <td>	₦{{ $viewsingle_paymentacc->amount}}</td>
                      </tr>
                    </table>
                  </div>
                </div>
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="{{ url('account/printsinglepaymentspdfs/'.$viewsingle_paymentacc->ref_no) }}" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>

          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>@if ($disall_payment->status == null)
                         ...
                         <td><a href="viewsinglepayments/{{ $disall_payment->id }}" class="btn btn-sm btn-primary float-left">View </a></td>
                         {{-- <td><a href="allthestudents" class="btn btn-sm btn-success float-left">Approved </a></td> --}}
                         <td><a href="{{ url('account/approvedsinglepayments/'.$disall_payment->id) }}" class="btn btn-sm btn-success float-left">Approved </a></td>
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="{{ route('account.printsinglepaymentspdfacc') }}" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print All</a>

          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">{{ Auth::guard('web')->user()->fathername }} {{ Auth::guard('web')->user()->fname }}  {{ Auth::guard('web')->user()->middlename }}</h3>

                <p class="text-muted text-center"> {{ Auth::guard('web')->user()->email }}</p>

                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Mothername</b> <a class="float-right">{{ Auth::guard('web')->user()->mothername  }}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Section</b> <a class="float-right">{{ Auth::guard('web')->user()->section  }}</a>
                  </li>
                  <li class="list-group-item">
                    <b>ID. Number</b> <a class="float-right">{{ Auth::guard('web')->user()->ref_no  }}</a>
                  </li>
                </ul>
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal" action="{{ url('web/parentupdateprofile/'.$view_profile->ref_no) }}" method="post" enctype="multipart/form-data">
                      @csrf
                      
                      @method('PUT')

                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label"> Fathername Name</label>
                        <div class="col-sm-10">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="mothername" value="{{ Auth::guard('web')->user()->mothername }}" class="form-control" id="inputName" placeholder="Last Name">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label"> Address</label>
                        <div class="col-sm-10">
                          <input type="text" name="officeaddress" value="{{ Auth::guard('web')->user()->officeaddress }}" class="form-control" id="inputName" placeholder="Address Name">
                        </div>
                      </div>
                      <div class="form-group row">

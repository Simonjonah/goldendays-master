  ...
  <section class="invoice">
    ...
    <div class="invoice p-3 mb-3">
      ...
      <div class="row">
        <div class="col-12">
          <h4>
            <td>{{ $printsingle_payment->ref_no }}</td>
      ...
      <div class="col-6">
            ...
            <table class="table">
                <tr>
                  ...
                  <td>	{{ $printsingle_payment->fname}}</td>
                </tr>
                <tr>
                  <th style="width:50%">Middle Name:</th>
                  <td>	{{ $printsingle_payment->middlename}}</td>
                </tr>

                <tr>
                  <th style="width:50%">SurName:</th>
                  <td>	{{ $printsingle_payment->surname}}</td>
                </tr>
                <tr>

                  <tr>
                    <th style="width:50%">Classname:</th>
                    <td>	{{ $printsingle_payment->classname}}</td>
                  </tr>
                  <tr>

                    <tr>
                      <th style="width:50%">Term:</th>
                      <td>	{{ $printsingle_payment->term}}</td>
                    </tr>
                    <tr>
                  <th style="width:50%">Form Amount:</th>
                  <td>	₦{{ $printsingle_payment->form_amount}}</td>
                </tr>
                <tr>
                  <th>Tuition</th>
                  <td>	₦{{ $printsingle_payment->tuition}}</td>
                </tr>

                <tr>
                  <th>Amount </th>
                  <td>	₦{{ $printsingle_payment->amount}}</td>
                </tr>
      ...
      <div class="col-6">
        ...
        <div class="table-responsive">
          <table class="table">
            <tr>
              <th>Book Amount</th>
              <td>₦{{ $printsingle_payment->bookamount }}</td>
            </tr>
            <tr>
              <th>Form Amount</th>
              <td>₦{{ $printsingle_payment->form_amount }}</td>
            ...
            <tr>
              ...
              <td>₦{{ $printsingle_payment->uniforms_amount }}</td>
            </tr>
            <tr>
              <th>Extra Curriculum Activities</th>
              <td>₦{{ $printsingle_payment->extracuri_fee }}</td>
            </tr>

            <tr>
              <th>Medicals</th>
              <td>₦{{ $printsingle_payment->medicals }}</td>
            </tr>
            <tr>
              <th>Development Amount</th>
              <td>	₦{{ $printsingle_payment->dev_amount}}</td>
            </tr>
            <tr>
              <th>PTA</th>
              <td>₦{{ $printsingle_payment->pta_amount }}</td>
            </tr>

            
            <tr>
              <th>Address </th>
              <td>{{ $printsingle_payment->address}}</td>
            </tr>

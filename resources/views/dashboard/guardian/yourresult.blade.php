          ...
          <div class="invoice p-3 mb-3">
            ...
            <div class="row">
              <div class="col-12">
                {{-- <h4>
                  ...
                  <small class="float-right"> <img style="width: 100px; height: 100px;" src="{{ asset('/public/../'.Auth::guard('guardian')->user()->passpot)}}" class="" alt="User Image"></small>
                </h4> --}}
              </div>
              <!-- /.col -->
            </div>
            ...
            <div class="row invoice-info">
              ...
              <div class="col-sm-4 invoice-col">
                ...
                <b> ID:</b> {{ Auth::guard('guardian')->user()->ref_no1 }}<br>
                <b>Admission Number</b> {{ Auth::guard('guardian')->user()->regnumber }}<br>
                <b>Section:</b> {{ Auth::guard('guardian')->user()->section }}<br>
                <b>Class</b> {{ Auth::guard('guardian')->user()->classname }}<br>
                <b>Gender</b> {{ Auth::guard('guardian')->user()->gender }}<br>
                <b>Centername</b> {{ Auth::guard('guardian')->user()->centername }}<br>
                <b>Term</b> {{ Auth::guard('guardian')->user()->entrylevel }}<br>
                <b>Session</b> {{ Auth::guard('guardian')->user()->academic_session }}<br>
              </div>
              <!-- /.col -->
              ...
              <div class="col-sm-4 invoice-col">
                ...
                <small class="float-right"> <img style="width: 200px; height: 200px;" src="{{ asset('/public/../'.Auth::guard('guardian')->user()->images)}}" class="" alt="User Image"></small>
              </div>
            </div>
            ...
            <div class="row no-print">
              <div class="col-12">
                {{-- <a href="{{ route('guardian.printresult') }}" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a> --}}
                {{-- <img src="{{ asset('assets/dist/img/signature.png') }}" alt=""> --}}
              </div>
            </div>
          </div>

        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Update Class and term {{ $assign_teachers->fname }} in {{ $assign_teachers->centername }} Center</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            ...
            <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select name="entrylevel" class="form-control"  id="">
                      ...
                      <option value="{{ $assign_teachers->entrylevel }}">{{ $assign_teachers->entrylevel }}</option>

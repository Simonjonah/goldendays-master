...
@endphp
    ...
    <table class="table">
        ...
        <tr>
            ...
            <th style="text-align: center; width: 450px;">GOLDEN SCHOOL ACADEMY
            ...
            <tr>
                <th colspan="2" style="text-align: center">FIRT TERM REPORT FOR 2022/2023 ACADEMIC SESSION <br>
                UDO, SIMON JONAH
                </th>
                <th>-</th>
            </tr>
        ...
        <table id="myTable">
            ...
            @php
                //$totalaverage +=$getyour_result->test_1 + $getyour_result->test_2 + $getyour_result->test_3 + $getyour_result->exams;

                  ...
                  {{-- @if (Auth::guard('web')->user()->section = 'Pre-School') --}}
                    ...
                    {{-- @if ($viewyour_children->centername == Auth::guard('web')->user()->centername && $viewyour_children->status == null) --}}
                      <tr>
                        ...
                        <td><a href="{{ url('guardian/parentviewstudent/'.$viewyour_children->ref_no1) }}"
                            class='btn btn-default'>
                            <i class="far fa-eye"></i>
                        </a></td>
                      
                      <td>{{ $viewyour_children->ref_no1 }}</td>
                        <td><a href="{{ url('guardian/parenteditstudent/'.$viewyour_children->ref_no1) }}"
                          class='btn btn-info'>
                        ...
                        <td><a href="{{ url('guardian/printstudents/'.$viewyour_children->ref_no1) }}"

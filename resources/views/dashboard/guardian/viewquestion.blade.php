          ...
          <div class="card-body">
            <div class="row">
              <div class="col-12 col-sm-6">
                ...
                <div class="form-group">
                  <p>Question</p>
                  <input type="text" class="form-control" value="{{ $view_singlequestion->question }}" name="question"  placeholder="Question">
              </div>

                <div class="form-group">
                  <p>Subject</p>
                  <input type="text" name="subjectname" class="form-control" value="{{ $view_singlequestion->subjectname }}" name="subjectname" id="" placeholder="Subject">
                </div>

                <div class="form-group">
                  <p>Option1</p>
                  <input type="text" class="form-control" value="{{ $view_singlequestion->option1 }}" name="option1" id="" placeholder="Option1">
                </div>

                <div class="form-group">
                  <p>Classname</p>
                  <input type="text" class="form-control" value="{{ $view_singlequestion->classname }}" name="classname" id="" placeholder="Classname">
                </div>
             ...
             <div class="col-12 col-sm-6">
                <div class="form-group">
                  <p>Option2</p>
                  <input type="text" class="form-control" value="{{ $view_singlequestion->option2 }}" name="option2" id="" placeholder="Option2">
                </div>

                <div class="form-group">
                  <p>Option3</p>
                  <input type="text" class="form-control" value="{{ $view_singlequestion->option3 }}" name="option3" id="" placeholder="Option3">
                </div>


              <div class="form-group">
                  <p>Answer</p>
                  <input type="text" class="form-control" value="{{ $view_singlequestion->is_correct }}" name="is_correct" id="" placeholder="Answer">
                </div>

                <div class="form-group">
									<h5>Term</h5>
									<select name="term" class="form-control"  id="">
										<option value="{{ $view_singlequestion->term }}">{{ $view_singlequestion->term }}</option>

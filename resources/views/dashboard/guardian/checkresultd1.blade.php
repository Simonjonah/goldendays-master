      ...
      <div id="accordion">
        ...
        <div class="card card-primary">
          ...
          <div id="collapseOne" class="panel-collapse collapse in">
            <div class="card-body">
              <form action="{{ route('student.yourresultd1') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group">
                    <div class="form-check">
                        <button type="submit" class="btn btn-info">Check First Semester D1</button>
                    </div>
                  </div>
                </div>
            </form>
        ...
        <div id="accordion">
          ...
          <div class="card card-danger">
            ...
            <div id="collapseTwo" class="panel-collapse collapse in">
              <div class="card-body">
              <a href="checksecondsemresultd2">ff</a>

                <form action="{{ route('student.yourresultd2') }}" method="post" enctype="multipart/form-data">
                  @csrf
                  @if (Session::get('success'))
                  <div class="alert alert-success">
                      {{ Session::get('success') }}
                ...
                @endif
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group">
                      <div class="form-check">
                          <button type="submit" class="btn btn-info">Check Second Semester D2</button>
                      </div>
                    </div>
                  </div>
              </form>

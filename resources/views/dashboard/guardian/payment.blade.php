                  ...
                  {{-- @if (Auth::guard('web')->user()->section = 'Pre-School') --}}
                    ...
                    {{-- @if ($viewyour_children->centername == Auth::guard('web')->user()->centername && $viewyour_children->status == null) --}}
                      <tr>
                        ...
                        <td><a href="{{ url('guardian/payschoolfees/'.$viewyour_children->classname) }}"
                            class='btn btn-default'>Pay School Fees
                            <i class="far fa-eye"></i>
                        </a></td>
                      

                        <td><a href="{{ url('guardian/payfeeding/'.$viewyour_children->classname) }}"

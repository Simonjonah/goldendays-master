        ...
        <div class="col-md-9">
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              ...
              <form action="{{ url('web/updateclassactivity/'.$edit_activities->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="subject" value="{{ $edit_activities->subject }}" placeholder="Subject">
                </div>

                <div class="form-group">
                    <input type="text" class="form-control" name="topic" value="{{ $edit_activities->topic }}" placeholder="Topic">
                  </div>

                  <div class="form-group">
                    <input type="url" class="form-control" name="youtube" value="{{ $edit_activities->youtube }}" placeholder="You Tube Link">
                  </div>
                <div class="form-group">
                    <textarea id="compose-textarea" name="messages" class="form-control" style="height: 300px">
                     
                     {!! $edit_activities->messages !!}

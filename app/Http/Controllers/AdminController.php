...
class AdminController extends Controller
{
    ...
    public function home(){
        ...
        return view('dashboard.admin.home', compact('count_results', 'view_results', 'countprimparent', 'countsecparent', 'countsparent', 'countsclasses', 'countsactivity', 'countsnoti', 'view_payments', 'countspayments', 'countstransactions', 'view_students', 'view_lecturers', 'countteachersecondary', 'countteacheruyo', 'countsrepliedqueries','countsqueries', 'countstudentreject', 'countstudentapprove', 'countstudenttsuspend', 'countteacher', 'countsubjectprim', 'countsubjecthigh', 'countsubjects', 'countstudent'));
    }
